...
| **[Manual de Usuario Cliente](file:///j:/Dev/Trabajo/STCcloud/STC-cloud/docs/cliente/STC_Manual_Usuario_Cliente_v1.6.html)** | **Clientes Finales / Operadores** | Guía de uso visual de la interfaz del portal y lectura de reportes de impresión. **ENTREGAR.** | `v1.6` (Activo) |
...
* **[AUDIT_DOSSIER.md](file:///j:/Dev/Trabajo/STCcloud/STC-cloud/docs/AUDIT_DOSSIER.md):** *Dossier de Auditoría Unificado*. Resumen condensado de las secciones de operaciones y sistemas. Incluye las mitigaciones de red (timeouts nativos de 65s) recientemente implementadas.
* **[SECURITY_AUDIT.md](file:///j:/Dev/Trabajo/STCcloud/STC-cloud/SECURITY_AUDIT.md) (en la raíz del proyecto):** *Reporte de Hardening y Ciberseguridad*. Contiene las directivas de seguridad aplicadas al backend Fastify y la base de datos (protección IDOR, rate-limiting, mitigación de XSS).
...
* **[CODE_MAP.md](file:///j:/Dev/Trabajo/STCcloud/STC-cloud/docs/dev/CODE_MAP.md):** Mapeo de la base de código. Ubicación de controladores, middleware, servicios y esquemas.
* **[ANTIGRAVITY_SKILLS.md](file:///j:/Dev/Trabajo/STCcloud/STC-cloud/docs/dev/ANTIGRAVITY_SKILLS.md):** Reglas estrictas de calidad de código y TypeScript del equipo. **Debe ser actualizado al añadir nuevas directivas.**
* **[STC_Technical_Architecture_Guide.md](file:///j:/Dev/Trabajo/STCcloud/STC-cloud/docs/dev/STC_Technical_Architecture_Guide.md):** Guía de arquitectura profunda (algoritmos de barrido EWS, pings, socket y control frames).
* **[PRINTER_COUNTER_METHODS.md](file:///j:/Dev/Trabajo/STCcloud/STC-cloud/docs/dev/PRINTER_COUNTER_METHODS.md):** Detalle técnico de extracción de contadores por marca y protocolo (Samsung, HP, Ricoh, Lexmark).
...
* **[agent_audit.md](file:///j:/Dev/Trabajo/STCcloud/STC-cloud/docs/security/agent_audit.md):** Análisis de seguridad del agente empaquetado.
* **[frontend_audit.md](file:///j:/Dev/Trabajo/STCcloud/STC-cloud/docs/security/frontend_audit.md):** Análisis del portal Next.js.
* **[VULNERABILITY_REPORT_v1.5.md](file:///j:/Dev/Trabajo/STCcloud/STC-cloud/docs/security/VULNERABILITY_REPORT_v1.5.md):** Matriz estática de riesgos iniciales corregidos.
