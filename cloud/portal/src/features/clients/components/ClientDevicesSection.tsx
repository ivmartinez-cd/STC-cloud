...
/** Rótulo de zona + exportar — fuera de la tarjeta medida por `useFitRows`, así
 * su alto no entra en el cálculo de filas. El acceso a la cola de pendientes
 * vive en la cabecera de la ficha (`ClientProfileCard`), no acá también
 * (auditoría de duplicados, 14/09/2026). */
