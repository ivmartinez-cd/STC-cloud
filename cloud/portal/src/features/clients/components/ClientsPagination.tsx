...
import { PAGE_SIZE } from '../hooks/useClientsDirectory';

/** Ventana de páginas con elipsis (primera, última, y 1 alrededor de la actual) —
 * evita renderizar 20+ botones cuando la cartera tiene cientos de clientes. */
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-2.5 px-5 py-3.5">
      <div className="font-sans text-xs text-ink-400">
        {fmt(from)}–{fmt(to)} de {fmt(total)} clientes
      </div>
