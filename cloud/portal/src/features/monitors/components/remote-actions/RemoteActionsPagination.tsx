...
/** Paginación de lotes — envoltorio fino sobre `HifiPagination` (la copia
...
export default function RemoteActionsPagination({
  ...
  return <HifiPagination page={page} totalPages={totalPages} total={total} pageSize={pageSize} itemLabel="lotes" onPageChange={onPageChange} />;
}
