...
export default function OfflineAgentsCard({ offlineAgents, now }: { offlineAgents: DashboardData['offlineAgents'] | undefined; now: number }) {
  return (
    <div className="cd-panel p-4 h-full min-h-0 flex flex-col overflow-hidden border-rose-500/10">
      ...
      {offlineAgents?.length === 0 ? (
        <div className="flex-1 min-h-0 flex flex-col items-center justify-center text-emerald-500/50 bg-emerald-50/50 rounded-2xl border border-emerald-100 border-dashed">
